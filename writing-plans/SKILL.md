...
After saving the plan, **lancer immédiatement en subagent-driven sans demander** :
- **REQUIRED SUB-SKILL:** Use superpowers:subagent-driven-development
- Stay in this session
- Fresh subagent per task + code review

Ne jamais poser la question "Subagent ou Parallel Session ?" — Mode Autonome Étendu : agir puis résumer.
